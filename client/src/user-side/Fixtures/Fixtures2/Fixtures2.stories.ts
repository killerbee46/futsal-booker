...
} satisfies Meta<typeof Fixture2>;

export default meta;
type Fixture_types = StoryObj<typeof meta>;

export const Fixture_two: Fixture_types = {
  args: {
    title: "Nepal Boxing Championship 2024",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Tempus parturient tempus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Tempus parturient tempus",
    date: "June 20, 2024",
    time: "11:45 AM",
